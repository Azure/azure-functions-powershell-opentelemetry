@{
    ...
    GUID = '6403f2f3-3da2-41e0-a31e-c2faf6677494'
    ...
    NestedModules = @('./AzureFunctions.PowerShell.OpenTelemetry.SDK.dll', './AzureFunctions.PowerShell.OpenTelemetry.SDK.psm1')
    ...
    CmdletsToExport = @(
        'New-FunctionsOpenTelemetryLogger',
        'Write-FunctionsOpenTelemetryLog',
        'Get-FunctionsLogHandlerInternal',
        'Start-OpenTelemetryInvocationInternal',
